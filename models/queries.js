...
exports.music = "CREATE TABLE IF NOT EXISTS music(music_id serial PRIMARY KEY, file_path varchar(225), music_title varchar(225), music_length integer NOT NULL, times_played integer DEFAULT 0, views integer DEFAULT 0)";
